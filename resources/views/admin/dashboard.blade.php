    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-dark fw-bold fs-1">All Questions</span>
                <!--begin::Description-->
        ...
        <div class="d-flex align-items-center py-1">
            ...
            <a href="{{ route('kegiatan.create') }}" class="btn btn-flex btn-sm btn-primary fw-bold border-0 fs-6 h-40px" id="kt_toolbar_primary_button">Kegiatan</a>
        ...
        <div class="mb-10">
            ...
            <div class="mb-0">
                ...
                <div class="d-flex align-items-center mb-4">
                    <!--begin::Title-->
                    <a href="../../demo5/dist/apps/devs/question.html" class="fs-2 fw-bold text-gray-900 text-hover-primary me-1">How to use Metronic with Django Framework ?</a>
                    <!--end::Title-->
                    <!--begin::Icons-->
                ...
                <div class="d-flex flex-stack flex-wrap">
                    ...
                    <div class="d-flex align-items-center py-1">
                        <!--begin::Answers-->
                        <a href="../../demo5/dist/apps/devs/question.html#answers" class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default px-4 me-2">16 Answers</a>
                        <!--end::Answers-->
                        <!--begin::Tags-->
                        <a href="../../demo5/dist/apps/devs/tag.html" class="btn btn-sm btn-light px-4 me-2">Metronic</a>
                        <!--end::Tags-->
                        <!--begin::Upvote-->
