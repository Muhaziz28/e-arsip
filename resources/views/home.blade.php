...
<div class="flex-shrink max-w-full w-full lg:w-2/3 overflow-hidden">
    <div class="flex flex-row flex-wrap">
        <div class="flex-shrink max-w-full w-full">
            <section class="h-full w-full border-box  pt-10 pb-8 px-8" style="background-color: #081b21">
    ...
    <div class="flex flex-row flex-wrap px-3 sm:px-4 xl:px-2">
        <section class="h-full w-full border-box lg:py-10 pb-8 xl:px-36 lg:px-24 md:px-16 sm:px-8 px-8 transition-all duration-500 linear">
            ...
            <div class="flex flex-row flex-wrap -mx-3">
                <div class="flex-shrink max-w-full w-full sm:w-1/3 px-3 pb-3 pt-3 sm:pt-0 border-b-2 sm:border-b-0 border-dotted border-gray-100 bg-red">
